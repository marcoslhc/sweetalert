...
'use strict';
  var getModal, getOverlay, hasClass, addClass, removeClass, escapeHtml, _show, show,
      ...
      previousActiveElement, previousDocumentClick, previousWindowKeyDown, lastFocusedButton, globalParent,
  ...
  function initialize() {
    ...
    globalParent = globalParent ? globalParent : document.body;
    globalParent.appendChild(sweetWrap);
  ...
  window.sweetAlert = window.swal = function () {
    ...
    switch (typeof arguments[0]) {
      ...
      case 'object':
        ...
        globalParent = arguments[0].parent;
