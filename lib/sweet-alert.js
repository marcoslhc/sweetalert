  ...
  window.sweetAlert = window.swal = function () {
    ...
    switch (typeof arguments[0]) {
      ...
      case 'object':
        ...
        params.contentStyle       = arguments[0].contentStyle;
...
console.log(params.contentStyle);
    if (params.contentStyle) {
        if(typeof params.contentStyle === 'string'){
            ...
            console.log(params.contentStyle);
            Object.keys(params.contentStyle).forEach(function (elm) {
                try {
                    $content.style[elm] = params.contentStyle[elm];
                } catch (e) {}
            });
        }
  ...
  function closeModal() {
    var $successIcon, $errorIcon, $warningIcon,
        modal = getModal();
